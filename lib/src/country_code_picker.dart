...
class CountryCodePickerState extends State<CountryCodePicker> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.builder != null)
      ...
      _widget = TextButton(
        onPressed:
            widget.enabled ? () => showCountryCodePickerDialog(context) : null,
        child: Padding(
  ...
  Widget _selectionDialog() => SelectionDialog(
        elements,
        favoriteElements,
  ...
  void _publishSelection(CountryCode e) => widget.onChanged?.call(e);

  void _onInit(CountryCode? e) => widget.onInit?.call(e);
}
